...
import com.nikati.manage.core.common.constant.dictmap.base.AbstractDictMap;
...
import com.nikati.manage.core.util.Contrast;
...
public class LogAop {
    ...
    @Pointcut(value = "@annotation(com.nikati.manage.core.common.annotion.BussinessLog)")
